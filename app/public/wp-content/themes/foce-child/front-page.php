...
<main id="primary" class="site-main">
    ...
    <section class="banner">
        ...
        <video class="banner__video" autoplay loop muted>
            <source src="<?php echo get_theme_file_uri() . '/assets/video.mp4'; ?>" type="video/mp4">
        </video>
        ...
        <article id="place" class="story__place">
            <div>
                ...
                <div class="parallax-container">
                    <img class="clouds" src="<?php echo get_stylesheet_directory_uri() . '/assets/images/clouds.png'; ?>"
                        alt="nuages qui se déplacent" />
                </div>
    ...
    <section id="nomination" class="nomination">
        ...
        <div class="nomination_title">
            <img src="<?php echo get_theme_file_uri() . '/assets/images/orange_background.png'; ?>"
                alt="arrière plan orange du titre des nominations">
            <h3>
        ...
        <img class="oscars_logo" src="<?php echo get_theme_file_uri() . '/assets/images/oscars_logo.png'; ?>"
            alt="image de nomination aux Oscars 2022">
        <div class="orchid">
